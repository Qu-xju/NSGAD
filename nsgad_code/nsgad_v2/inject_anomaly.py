...
if __name__ == "__main__":
    ...
    if not os.path.exists(savedir):
    	os.makedirs(savedir)
    sio.savemat('dataset/{}{}.mat'.format(stru_type,dataset_str),\
    ...
    print('Done. The file is save as: dataset/{}{}.mat \n'.format(stru_type,dataset_str))
    sio.savemat('dataset/{}{}.mat'.format(attr_type,dataset_str),\
                {'Network': adj, 'Label': attr_anomaly_label, 'Attributes': attribute,\
                 'Class':cat_labels, 'str_anomaly_label':str_anomaly_label, 'attr_anomaly_label':attr_anomaly_label})
    print('Done. The file is save as: dataset/{}{}.mat \n'.format(attr_type,dataset_str))
